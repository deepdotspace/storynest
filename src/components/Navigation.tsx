    ...
    <>
      ...
      >
        <div className="mx-auto flex h-14 max-w-7xl items-center gap-4 px-4 sm:px-6 lg:px-8">
          {/* Brand — wordmark in EB Garamond italic. */}
          <Link to="/" className="flex items-center gap-2 shrink-0">
            <span className="h-1.5 w-1.5 rounded-full" style={{ background: 'var(--storynest-marigold, var(--color-primary))' }} />
            <span
              className="font-serif italic text-[18px] tracking-tight text-foreground"
...
function ProBadge() {
  ...
  return (
    <span
      ...
      className="hidden sm:inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-medium uppercase tracking-[0.05em]"
      style={{
